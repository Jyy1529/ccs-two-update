...
基于 [CC Switch](https://github.com/farion1231/cc-switch) 的二次开发版本，重点增强 Codex 本地代理、审批模型路由、子代理角色路由、供应商重试与迁移，以及 Windows 端 Codex Desktop 修复能力。

本仓库用于保存二次开发源码和历史归档。上游 CC Switch 的版权、许可证和原始设计归原作者及贡献者所有。
...
本项目基于 [CC Switch](https://github.com/farion1231/cc-switch) 进行二次开发。感谢上游作者和所有贡献者提供的基础实现。

许可证以仓库中的 [LICENSE](LICENSE) 和上游项目许可条款为准。第三方组件说明见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
