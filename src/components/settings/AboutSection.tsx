    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/Jyy1529/ccs-two-update/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/Jyy1529/ccs-two-update/releases/tag/${displayVersion}`,
      );
    } catch (error) {
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/Jyy1529/ccs-two-update",
                )
              }
              className="h-8 gap-1.5 text-xs"
            >
