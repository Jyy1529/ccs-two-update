...
async fn get_single_tool_version_impl(
    ...
    let latest_version = match tool {
        ...
        // Hermes publishes versions through GitHub Releases rather than PyPI.
        // Keep the upstream detector for Hermes and retain the DSH npm path.
...
pub async fn open_provider_terminal(
    ...
    let ticket = crate::app_management::WriteTicket::capture(&app_type).map_err(|e| e.to_string())?;
    ...
    let _native = crate::app_management::native_mutation_guard().map_err(|e| e.to_string())?;
